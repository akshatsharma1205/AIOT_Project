...
def main():
    ...
    for i in range(1, args.num_messages + 1):
        ...
        payload = {"timestamp": int(time.time()), "device": args.device_id,
         "TempIn": simulated_temp,
         "TempOut": simulated_temp_out,
         "Pressure": sim_pressure,
         "HumidityIn": sim_hum,
         "HumidityOut": sim_hum_out,
         "UVIndex": sim_uv,
         "SolarIrradiance": sim_irr,
         "SoilMoisture": sim_smoist,
         "CarbonDioxidePPB": sim_co2,
         "MethanPPB": sim_ch4,
         "NitrousOxidePPB": sim_n20,
         "CFC11PPB": sim_cfc,
         "GIndex": g_score}
